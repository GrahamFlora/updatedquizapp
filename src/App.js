...
const examLibrary = [
    ...
    },
    {
        ...
        "explanation": "This question could go either way for A or B. But Big Query was designed with this in mind, according to numerous Google presentation and videos. Cloud Datastore is a NoSQL database (https://cloud.google.com/datastore/docs/concepts/overview)\nCloud Storage does not have an SQL interface. The previous two sentences eliminate options C and D. So I'd pick \"A\"."
    },
    {
        "id": "gcp-q3",
    ...
    },
    {
        ...
        "explanation": "A. This is GCP exam. They will always promote their services. Not a third party solution."
    },
    {
        "id": "gcp-q6",
    ...
    },
    {
        ...
        "explanation": "\"A\" and \"B\" wouldn't turn the VMs on or off, it would jsut prevent traffic. \"C\" would turn them off if the health check is configured to terminate the VM is it fails. \"D\" is the start of a pseudo health check without any logic, so it also isn't an answer because it is like \"A\" and \"B\". Correct Answer: \"C\""
    },
    {
        "id": "gcp-q10",
    ...
    },
    {
        ...
        "explanation": "A is the correct answer because the question says \"with minimum downtime\""
    },
    {
        "id": "gcp-q15",
        ...
        "explanation": "Final Decision to go with Option A. I have done PCI DSS Audit for my project and thats the best suited case. 100% sure to use tokenised data instead of actual card number"
    },
    {
        "id": "gcp-q16",
        ...
        "explanation": "B. Google Cloud Bigtable"
    },
    {
        "id": "gcp-q17",
    ...
    },
    {
        ...
        "explanation": "\"B. Google Cloud Dataproc\" is the answer"
    },
    {
        "id": "gcp-q19",
        ...
        "explanation": "Answer is C because persistent disk performance is based on the total persistent disk capacity attached to an instance and the number of vCPUs that the instance has. Incrementing the persistent disk capacity will increment its throughput and IOPS, which in turn improve the performance of MySQL."
    },
    {
        "id": "gcp-q20",
        ...
        "explanation": "C. Google Cloud Bigtable"
    },
    {
        "id": "gcp-q21",
        ...
        "explanation": "resilience test is not about load, is about terminate resources and service not affected. Think it's B. The best for resilience in to introduce chaos in the infraestructure"
    },
    {
        "id": "gcp-q22",
    ...
    },
    {
        ...
        "explanation": "B. https://cloud.google.com/iam/docs/roles-audit-logging#scenario_external_auditors"
    },
    {
        "id": "gcp-q29",
        ...
        "explanation": "Google Secret Management was designed explicitly for this purpose."
    },
    {
        "id": "gcp-q30",
        ...
        "explanation": "E. Cloud Deployment Manager can be used to permanently delete cloud resources\nF. Cloud Deployment Manager only supports automation of Google Cloud resources"
    },
    {
        "id": "gcp-q31",
        ...
        "explanation": "it should be A .. helm is needed for \"Deploy application bundles using dynamic templates\"\n\nLoad Balancing should be part of GKE Already"
    },
    {
        "id": "gcp-q32",
        ...
        "explanation": "https://cloud.google.com/compute/docs/shutdownscript ... So C"
    },
    {
        "id": "gcp-q33",
    ...
    },
    {
        ...
        "explanation": "https://cloud.google.com/docs/enterprise/best-practices-for-enterprise-organizations\n\nI will stick with C"
    },
    {
        "id": "gcp-q38",
        ...
        "explanation": "Signing the JAR files grants it permissions. (https://docs.oracle.com/javase/tutorial/deployment/jar/signindex.html)"
    },
    {
        "id": "gcp-q39",
    ...
    },
    {
        ...
        "explanation": "It's latency issues. That won't be solved by adding another VPN tunnel. If it was just a throughput issue then VPN would do, however to improve latency you need to go layer 2. Answer is B"
    },
    {
        "id": "gcp-q41",
    ...
    },
    {
        ...
        "explanation": "Cloud VPN supports unto 3 Gbps where as Interconnect can support unto 100 gbps... I'll go with A"
    },
    {
        "id": "gcp-q44",
    ...
    },
    {
        ...
        "explanation": "The effective policy for a resource is the union of the policy set at that resource and the policy inherited from its parent.https://cloud.google.com/iam/docs/resource-hierarchy-access-control"
    },
    {
        "id": "gcp-q50",
    ...
    },
    {
        ...
        "explanation": "Correct A, you have to recreate the indexes"
    },
    {
        "id": "gcp-q52",
        ...
        "explanation": "Groups are better for management that non-groups so A and B are eliminated. Keeping the the instances in the same project will help maintain consistency, so C is better than D."
    },
    {
        "id": "gcp-q53",
    ...
    },
    {
        ...
        "explanation": "Internet access is not allowed so it should be A. CMIIW"
    },
    {
        "id": "gcp-q55",
    ...
    },
    {
        ...
        "explanation": "It has to be B. gcloud for creating cluster and kubectl for creating deployment"
    },
    {
        "id": "gcp-q62",
    ...
    },
    {
        ...
        "explanation": "C is correct, need \"ifnotpresent\"when uploads to container registry"
    },
    {
        "id": "gcp-q68",
    ...
    },
    {
        ...
        "explanation": "think answer is B. C cannot be, you don't need to connect to the container to view logs, you connect to stackdriver for this"
    },
    {
        "id": "gcp-q70",
    ...
    },
    {
        ...
        "explanation": "The easiest way would be to create template from --source-instance, and then create MIG, but it is not listed here, also you cannot create a MIG from image directly, you need a template, so answer is C (image -> template -> mig)."
    },
    {
        "id": "gcp-q72",
    ...
    },
    {
        ...
        "explanation": "post mortem always includes log analysis, answer is C"
    },
    {
        "id": "gcp-q76",
    ...
    },
    {
        ...
        "explanation": "I think B is correct answer."
    },
    {
        "id": "gcp-q81",
        ...
        "explanation": "Disabling and then discontinuing allows you to see the effects of not using the APIs, so you can gauge (check) alternatives. So that leaves B and D as viable answers. The question says only some are not time-critical which implies others are... this means preemptible VMs are good because they will secure a spot for scaling when needed. So I'm also going to choose B."
    },
    {
        "id": "gcp-q82",
    ...
    },
    {
        ...
        "explanation": "Why is it not answer B?"
    },
    {
        "id": "gcp-q85",
        ...
        "explanation": "It should be A. The question requires that user from each country can only view a specific data set, so BQ dataViewer cannot be assigned at project level. Only A could limit the user to query and view the data that they are supposed to be allowed to."
    },
    {
        "id": "gcp-q86",
    ...
    },
    {
        ...
        "explanation": "Does not agree with D. B is the nearest answer I feel !"
    },
    {
        "id": "gcp-q90",
        ...
        "explanation": "I think B is correct. Because GAE supports service version control and A/B test.\nIs my understanding correct?"
    },
    {
        "id": "gcp-q91",
    ...
    },
    {
        ...
        "explanation": "Why not using Ingress? (A)"
    },
    {
        "id": "gcp-q94",
        ...
        "explanation": "B. Create an HTTPS load balancer with URL maps."
    },
    {
        "id": "gcp-q95",
    ...
    },
    {
        ...
        "explanation": "I think answer B is correct:\nhttps://cloud.google.com/solutions/dr-scenarios-planning-guide"
    },
    {
        "id": "gcp-q97",
        ...
        "explanation": "Its D, create multi region buckets in Americas, Europe and Asia"
    },
    {
        "id": "gcp-q98",
    ...
    },
    {
        ...
        "explanation": "With option A, daily data would take 27 hours.\nMy answer is B.\nHow do you think?"
    },
    {
        "id": "gcp-q102",
        ...
        "explanation": "I believe the answer is B.  \"Pub/Sub doesn't provide guarantees about the order of message delivery. Strict message ordering can be achieved with buffering, often using Dataflow.\"  https://cloud.google.com/solutions/data-lifecycle-cloud-platform"
    },
    {
        "id": "gcp-q103",
    ...
    },
    {
        ...
        "explanation": "C. 1. Set up Cloud VPN to provide private network connectivity between the Compute Engine application and the on-premises MySQL server. 2. Stop the on-premises application. 3. Start the Compute Engine application, configured to read and write to the on-premises MySQL server. 4. Create the replication configuration in Cloud SQL. 5. Configure the source database server to accept connections from the Cloud SQL replica. 6. Finalize the Cloud SQL replica configuration. 7. When replication has been completed, stop the Compute Engine application. 8. Promote the Cloud SQL replica to a standalone instance. 9. Restart the Compute Engine application, configured to read and write to the Cloud SQL standalone instance."
    },
    {
        "id": "gcp-q113",
    ...
    },
    {
        ...
        "explanation": "B. Create a Debian-based Compute Engine instance, install and configure the application, and use OS patch management to install available updates."
    },
    {
        "id": "gcp-q122",
    ...
    },
    {
        ...
        "explanation": "Answer should be C, obviously."
    },
    {
        "id": "gcp-q127",
    ...
    },
    {
        ...
        "explanation": "Any correct answer must involve Cloud Bigtable over BigQuery since Bigtable is optimized for heavy write loads. That leaves B and D. I would suggest B b/c it is lower cost (\"The business wants to keep costs low\")"
    },
    {
        "id": "gcp-q129",
    ...
    },
    {
        ...
        "explanation": "For the same project , same VPC, Network Admin role to the networking team, and Compute Admin role to the development team. What is the need for another project?"
    },
    {
        "id": "gcp-q131",
    ...
    },
    {
        ...
        "explanation": "A, App Engine, you just want you people dedicated to the App"
    },
    {
        "id": "gcp-q137",
    ...
    },
    {
        ...
        "explanation": "decoupling, new features, CI/CD, A/B testing, scaling is the advantage so C"
    },
    {
        "id": "gcp-q139",
    ...
    },
    {
        ...
        "explanation": "Developer shouldn't tag or comment every commit with some specific data, like timestamps or something else. There might be an app version, but it's not mentioned. I'd go with C as it's an automated, error-less approach that answers the question."
    },
    {
        "id": "gcp-q142",
    ...
    },
    {
        ...
        "explanation": "B. Create a key with Cloud Key Management Service (KMS). Set the encryption key on the bucket to the Cloud KMS key."
    },
    {
        "id": "gcp-q150",
        ...
        "explanation": "Cloud NAT is the correct answer"
    },
    {
        "id": "gcp-q151",
        ...
        "explanation": "D is right , refer to https://cloud.google.com/vpc/docs/serverless-vpc-access#use_cases"
    },
    {
        "id": "gcp-q152",
    ...
    },
    {
        ...
        "answerOptions": [
            {
                "answerText": "N. The security team wants to avoid data exfiltration by malicious insiders, compromised code, and accidental oversharing.What should they do?",
                "isCorrect": false
            },
            {
        ...
        "explanation": "Without the discussion this site would be useless, many thanks to all that participate.  Majority of answers are wrong..."
    },
    {
        "id": "gcp-q157",
    ...
    },
    {
        ...
        "explanation": "B, https://cloud.google.com/compute/docs/autoscaler/"
    },
    {
        "id": "gcp-q159",
    ...
    },
    {
        ...
        "explanation": "D is correct. A and B are talking about appending the file system to a new VM, not setting it at the root in a new VM set. Option C is not offered within the GCP because the image must be on the GCP platform to run the gcloud of Google Console instructions to create a VM with the image."
    },
    {
        "id": "gcp-q163",
    ...
    },
    {
        ...
        "explanation": "A & C seems to be the correct answer."
    },
    {
        "id": "gcp-q169",
    ...
    },
    {
        ...
        "explanation": "C, because managing multiple organizations is not a Google best practice"
    },
    {
        "id": "gcp-q172",
    ...
    },
    {
        ...
        "explanation": "Save logs for 1 year you must include cloud storage."
    },
    {
        "id": "gcp-q174",
        ...
        "explanation": "Option-A is correct. Although Option-C sounds good, ultimately we should not store PI data at all as per question says."
    },
    {
        "id": "gcp-q175",
    ...
    },
    {
        ...
        "explanation": "LOL , if we give this question to someone who know nothing about GCP they will select A"
    },
    {
        "id": "gcp-q178",
        ...
        "explanation": "Option-C is correct: https://cloud.google.com/bigtable/docs/schema-design#row-keys"
    },
    {
        "id": "gcp-q179",
        ...
        "answerOptions": [
            {
                "answerText": "I. The other information in the tables must be available to the data science team. You want to minimize cost and the time it takes to assign appropriate access to the tables. What should you do?",
                "isCorrect": false
            },
            {
    ...
    },
    {
        ...
        "explanation": "I would have voted C looking at 10 TB at first glance. But the senario other cloud storge changes the look out. You cannot wre master applica here. As you wont be able to remove and store data like on prem. Hence is or Starge Transfer service."
    },
    {
        "id": "gcp-q181",
        ...
        "explanation": "Actually C is correct but Wrong also in a way .. Sink cannot trigger a cloud function directly. It need Pub/Sub which then will trigger Cloud Function."
    },
    {
        "id": "gcp-q182",
    ...
    },
    {
        ...
        "explanation": "VPC peering cannot be established between VPCs if there is IP range overlap. C is ok since you can establish VPN across these VPCs and only include the applications required IP ranges as its mentioned that they do not overlap"
    },
    {
        "id": "gcp-q184",
        ...
        "explanation": "First thing to do is to inspect logs and monitoring to see what is happening"
    },
    {
        "id": "gcp-q185",
        ...
        "explanation": "A: Configuring the right liveness and readiness probes prevents outages when rolling out a new ReplicaSet of a Deployment, because Pods are only getting traffic when they are considered ready.\nB: With GKE, you do not deal with MIGs.\nC: Does not use GKE tools and is therefore not the best option.\nD: Does alert you but does not prevent the outage."
    },
    {
        "id": "gcp-q186",
    ...
    },
    {
        ...
        "explanation": "I choose B because of \"real-time\". Otherwise, D seems to be the most relevant and flexible."
    },
    {
        "id": "gcp-q188",
    ...
    },
    {
        ...
        "explanation": "Object Versioning is a feature that allows you to store multiple versions of an object in Cloud Storage. Hence, answer should be B"
    },
    {
        "id": "gcp-q190",
        ...
        "answerOptions": [
            ...
            {
                "answerText": "A. Change the Target type to DELTA_PER_MINUTE. (in this case the utlization tagret need to be in minutes which is not the case its percentage % and not time based.",
                "isCorrect": false
            },
            {
                "answerText": "B. Change the Metric identifier to agent.googleapis.com/memory/bytes_used. (not applicable)",
                "isCorrect": false
            },
            {
                "answerText": "C. Change the filter to metric.label.state = 'used' AND metric.label.state = 'buffered' AND metric.label.state = 'cached' AND metric.label.state = 'slab'. (this gives total memory used)",
                "isCorrect": false
            }
        ],
    ...
    },
    {
        ...
        "explanation": "A is true only if the on-prem (peer) gateway has two separate external P addresses. The HA VPN gateway uses two tunnels, one tunnel to each external IP address on the peer device as described in https://cloud.google.com/network-connectivity/docs/vpn/concepts/topologies#configurations_that_support_9999_availability\n\nC is a complete solution that provides full redundancy of the on-prem gateway. This is probably more expensive and having two HA VPN Gateways is an unusual configuration as the online documentation only describes using one HA VPN Gateway\n\nA appears to be correct with assumptions...!"
    },
    {
        "id": "gcp-q192",
        ...
        "explanation": "It should be A. Since it is stated that the payload should not passed from the backend and be send directly to the bucket, then a CORS configuration should be set to the bucket."
    },
    {
        "id": "gcp-q193",
    ...
    },
    {
        ...
        "explanation": "Yep, this question is a duplicate of #191."
    },
    {
        "id": "gcp-q196",
    ...
    },
    {
        ...
        "explanation": "I am confused since this question comes in contrast with the answer in question 190. Anyone knows what is the real answer? I would expected used+buffered+cached+slab Which means the sum of all these."
    },
    {
        "id": "gcp-q200",
        ...
        "answerOptions": [
            {
                "answerText": "N. Your security team wants to avoid data exfiltration by malicious insiders, compromised code, and accidental oversharing. What should you do?",
                "isCorrect": false
            },
            {
        ...
        "explanation": "Answer is B, and I think the question is duplicated"
    },
    {
        "id": "gcp-q201",
    ...
    },
    {
        ...
        "explanation": "Business Requirements include: Guarantee service availability and support. I would choose C"
    },
    {
        "id": "gcp-q205",
    ...
    },
    {
        ...
        "explanation": "A - configuration by Organization policy service"
    },
    {
        "id": "gcp-q219",
    ...
    },
    {
        ...
        "explanation": "@jcmoranp , that is incorrect.. https://cloud.google.com/bigtable/docs/schema-design-time-series it's A"
    },
    {
        "id": "gcp-q232",
        ...
        "explanation": "It's C. You need a L7 balancer and multi-zone"
    },
    {
        "id": "gcp-q233",
        ...
        "explanation": "hey guys new Qs posted as of July 12th, 2021, All 21 new Qs in Question #152"
    },
    {
        "id": "gcp-q234",
    ...
    },
    {
        ...
        "explanation": "It's Pub/Sub, too much data streaming for Bigquery..."
    },
    {
        "id": "gcp-q244",
    ...
    },
    {
        ...
        "explanation": "B is correct. only 200k vehicle's are connected so need to run updates locally"
    },
    {
        "id": "gcp-q251",
    ...
    },
    {
        ...
        "explanation": "Bigquery partitioning, A. Federated makes no sense..."
    },
    {
        "id": "gcp-q254",
    ...
    },
    {
        ...
        "explanation": "A&C. Though if in real life we will do D :-)"
    },
    {
        "id": "gcp-q260",
    ...
    },
    {
        ...
        "explanation": "https://cloud.google.com/architecture/best-practices-for-building-containers#tagging_using_the_git_commit_hash\nA is ok"
    },
    {
        "id": "gcp-q262",
        ...
        "explanation": "USB...where can I buy a 1 PB USB ...?"
    },
    {
        "id": "gcp-q263",
        ...
        "explanation": "I thought operations team doesn't need SSH access to manage VMs. All it needs is Cloud Shell with the Cloud SDK and gcloud tools.\nMaybe A is correct answer."
    },
    {
        "id": "gcp-q264",
    ...
    },
    {
        ...
        "explanation": "It is C. \nWith D you cannot achieve \"Their administrators are notified automatically when their application reports errors.\" However with Error Reporting(Log insights) - Notifies you when new errors are detected.\nSo I will go with C"
    },
    {
        "id": "gcp-q267",
        ...
        "explanation": "A looks better for me."
    },
    {
        "id": "gcp-q268",
        ...
        "explanation": "I think D it can't be, because you want to load a dump in a Cloud Datastore. If it were a Cloud Storage, it could be, but a Cloud datastore is a nosql.\nIt's true that you hace to use a dump, but to create a replica server/slave to promote to Cloud SLQ. So I think it is B."
    },
    {
        "id": "gcp-q269",
    ...
    },
    {
        ...
        "explanation": "C- I would run the same test suite in cloud) to see what breaks"
    },
    {
        "id": "gcp-q272",
        ...
        "explanation": "I think it's A, because when you read documentation both of them (nearline and coldline) you can see the expresion infrecuent access. And in this case, your priority is the cost, and you are going to sabe 10 years"
    },
    {
        "id": "gcp-q273",
        ...
        "explanation": "Agree. A looks correct for me."
    },
    {
        "id": "gcp-q274",
    ...
    },
    {
        ...
        "explanation": "It's A, \"Cloud Datastore server\" doesn't exist. A fits OK."
    },
    {
        "id": "gcp-q276",
        ...
        "explanation": "Question is about compute services to be migrated as \"\"is and would still be an optimized architecture for performance - Apache Hadoop/Spark servers underline is compute and Hadoop/Spark deployed using Cloud Dataproc   seems to be the correct answer.. Hence  C seems correct answer to me"
    },
    {
        "id": "gcp-q277",
